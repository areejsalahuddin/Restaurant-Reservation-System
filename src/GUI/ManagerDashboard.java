...
public class ManagerDashboard {
    ...
    public void prepareScene() {
        Label dashboard = new Label("  Manager Dashboard  ");
        ...
        Label viewReservationsLabel = new Label("Today's Reservations and Revenue:");
        ...
        Label view = new Label(manager.viewEmployeeDashboard(restaurant));
